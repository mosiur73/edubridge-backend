...
var getAllTutors, getTutorById, getTutorProfileByUserId, createTutorProfile, updateTutorProfile, getTutorStats, getTutorSessions, tutorService;
var init_tutor_service = __esm({
  "src/modules/tutor/tutor.service.ts"() {
    ...
    getTutorProfileByUserId = async (userId) => {
    ...
    createTutorProfile = async (userId, data) => {
      const {
        headline,
        bio,
        hourlyRate,
    ...
    updateTutorProfile = async (userId, data) => {
      const {
        headline,
        bio,
        hourlyRate,
    ...
    getTutorSessions = async (userId, status) => {
      const tutorProfile = await prisma.tutorProfile.findUnique({
        where: { userId }
      });
      if (!tutorProfile) {
...
var getAllTutors2, getTutorById2, getMyProfile, createProfile, updateProfile, getStats, getMySessions, tutorController;
...
var createBooking, getMyBookings, getBookingById, markComplete, cancelBooking, bookingService;
var init_booking_service = __esm({
  "src/modules/booking/booking.service.ts"() {
    "use strict";
    init_prisma();
    createBooking = async (studentId, payload) => {
    ...
    getMyBookings = async (userId, userRole, status) => {
      let where = {};
      if (userRole === "STUDENT") {
    ...
    getBookingById = async (bookingId, userId, userRole) => {
    ...
    markComplete = async (bookingId, userId) => {
      const tutorProfile = await prisma.tutorProfile.findUnique({
        where: { userId }
      });
      if (!tutorProfile) {
...
var createBooking2, getMyBookings2, getBookingById2, markBookingComplete, cancelBooking2, bookingController;
...
var router2, bookingRouter;
var init_booking_routes = __esm({
  "src/modules/booking/booking.routes.ts"() {
    "use strict";
    init_auth2();
    ...
    bookingRouter = router2;
  }
});

// src/modules/review/review.service.ts
var updateTutorRating, createReview, getTutorReviews, reviewService;
var init_review_service = __esm({
  "src/modules/review/review.service.ts"() {
    "use strict";
    init_prisma();
    updateTutorRating = async (tutorId) => {
    ...
    createReview = async (studentId, payload) => {
...
var createReview2, getTutorReviews2, reviewController;
...
var init_review_routes = __esm({
  "src/modules/review/review.routes.ts"() {
    ...
    reviewRouter = router3;
  }
});

// src/modules/availability/availability.service.ts
var createAvailability, getMyAvailability, updateAvailability, deleteAvailability, availabilityService;
var init_availability_service = __esm({
  "src/modules/availability/availability.service.ts"() {
    "use strict";
    init_prisma();
    createAvailability = async (userId, payload) => {
    ...
    updateAvailability = async (availabilityId, userId, data) => {
    ...
    deleteAvailability = async (availabilityId, userId) => {
      const slot = await prisma.availability.findUnique({
        where: { id: availabilityId },
        include: {
          tutor: true
...
var createAvailability2, getMyAvailability2, updateAvailability2, deleteAvailability2, availabilityController;
...
var router4, availabilityRouter;
var init_availability_routes = __esm({
  "src/modules/availability/availability.routes.ts"() {
    ...
    availabilityRouter = router4;
  }
});

// src/modules/category/category.service.ts
var getAllCategories, categoryService;
...
var getAllCategories2, categoryController;
...
var init_category_routes = __esm({
  "src/modules/category/category.routes.ts"() {
    ...
    categoryRouter = router5;
  }
});

// src/modules/admin/admin.service.ts
var getStats2, getAllUsers, getAllBookings, getAllCategories3, createCategory, updateCategory, banUser, unbanUser, adminService;
...
var getStats3, getAllUsers2, getAllBookings2, getAllCategories4, createCategory2, updateCategory2, banUser2, unbanUser2, adminController;
var init_admin_controller = __esm({
  "src/modules/admin/admin.controller.ts"() {
    ...
    getAllCategories4 = async (req, res) => {
      try {
