...
const createAvailability = async (userId, payload) => {
    ...
    const overlappingSlot = await prisma_1.prisma.availability.findFirst({
        where: {
...
const updateAvailability = async (availabilityId, userId, data) => {
    ...
    // Update availability
    const updatedSlot = await prisma_1.prisma.availability.update({
        where: { id: availabilityId },
        data: {
