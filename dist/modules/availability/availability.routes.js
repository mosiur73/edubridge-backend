...
router.get("/", (0, auth_1.default)(auth_1.UserRole.TUTOR), availability_controller_1.availabilityController.getMyAvailability); //ok
router.post("/", (0, auth_1.default)(auth_1.UserRole.TUTOR), availability_controller_1.availabilityController.createAvailability); //ok
