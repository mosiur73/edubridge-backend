...
router.get("/", (0, auth_1.default)(auth_1.UserRole.STUDENT, auth_1.UserRole.TUTOR, auth_1.UserRole.ADMIN), booking_controller_1.bookingController.getMyBookings);
router.get("/:id", (0, auth_1.default)(auth_1.UserRole.STUDENT, auth_1.UserRole.TUTOR, auth_1.UserRole.ADMIN), booking_controller_1.bookingController.getBookingById);
